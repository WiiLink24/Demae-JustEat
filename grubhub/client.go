...
// NewClient constructs either an instance of GHClient or skip.Client.
...
func (j *GHClient) refreshAuthToken(refreshToken, acr, hash string) (string, error) {
